...
class AllStoreProductsModel {
  ...
  factory AllStoreProductsModel.fromJson(Map<String, dynamic> json) {
    return AllStoreProductsModel(
      ...
      pivot: json['pivot'] != null ? FollowPivotModel.fromJson(json['pivot']) : null, 
    );
  }
}
...
//   AllStoreResponse({required this.success, required this.data});
...
//   Pivot({required this.storeId, required this.categoryId});
